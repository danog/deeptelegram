...
static const char *FileLoadOperationClassPathName = "it/deeptelegram/tgnet/FileLoadOperation";
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("it/deeptelegram/tgnet/FileLoadOperationDelegate"));
