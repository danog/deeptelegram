...
import it.deeptelegram.messenger.exoplayer.drm.FrameworkMediaCrypto;
import it.deeptelegram.messenger.exoplayer.util.Assertions;
import it.deeptelegram.messenger.exoplayer.util.NalUnitUtil;
import it.deeptelegram.messenger.exoplayer.util.TraceUtil;
...
public abstract class MediaCodecTrackRenderer extends SampleSourceTrackRenderer {
  ...
  public static class DecoderInitializationException extends Exception {
    ...
    private static String buildCustomDiagnosticInfo(int errorCode) {
      ...
      return "it.deeptelegram.messenger.exoplayer.MediaCodecTrackRenderer_" + sign + Math.abs(errorCode);
    }
