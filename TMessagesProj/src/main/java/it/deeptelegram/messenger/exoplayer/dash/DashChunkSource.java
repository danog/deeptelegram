 ...
 */
package it.deeptelegram.messenger.exoplayer.dash;

import android.os.Handler;
import android.util.Log;
import android.util.SparseArray;
import it.deeptelegram.messenger.exoplayer.BehindLiveWindowException;
import it.deeptelegram.messenger.exoplayer.C;
import it.deeptelegram.messenger.exoplayer.MediaFormat;
import it.deeptelegram.messenger.exoplayer.TimeRange;
import it.deeptelegram.messenger.exoplayer.TimeRange.DynamicTimeRange;
import it.deeptelegram.messenger.exoplayer.TimeRange.StaticTimeRange;
import it.deeptelegram.messenger.exoplayer.chunk.Chunk;
import it.deeptelegram.messenger.exoplayer.chunk.ChunkExtractorWrapper;
import it.deeptelegram.messenger.exoplayer.chunk.ChunkOperationHolder;
import it.deeptelegram.messenger.exoplayer.chunk.ChunkSource;
import it.deeptelegram.messenger.exoplayer.chunk.ContainerMediaChunk;
import it.deeptelegram.messenger.exoplayer.chunk.Format;
import it.deeptelegram.messenger.exoplayer.chunk.Format.DecreasingBandwidthComparator;
import it.deeptelegram.messenger.exoplayer.chunk.FormatEvaluator;
import it.deeptelegram.messenger.exoplayer.chunk.FormatEvaluator.Evaluation;
import it.deeptelegram.messenger.exoplayer.chunk.InitializationChunk;
import it.deeptelegram.messenger.exoplayer.chunk.MediaChunk;
import it.deeptelegram.messenger.exoplayer.chunk.SingleSampleMediaChunk;
import it.deeptelegram.messenger.exoplayer.dash.DashTrackSelector.Output;
import it.deeptelegram.messenger.exoplayer.dash.mpd.AdaptationSet;
import it.deeptelegram.messenger.exoplayer.dash.mpd.ContentProtection;
import it.deeptelegram.messenger.exoplayer.dash.mpd.MediaPresentationDescription;
import it.deeptelegram.messenger.exoplayer.dash.mpd.Period;
import it.deeptelegram.messenger.exoplayer.dash.mpd.RangedUri;
import it.deeptelegram.messenger.exoplayer.dash.mpd.Representation;
import it.deeptelegram.messenger.exoplayer.drm.DrmInitData;
import it.deeptelegram.messenger.exoplayer.extractor.ChunkIndex;
import it.deeptelegram.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor;
import it.deeptelegram.messenger.exoplayer.extractor.webm.WebmExtractor;
...
import it.deeptelegram.messenger.exoplayer.util.ManifestFetcher;
import it.deeptelegram.messenger.exoplayer.util.MimeTypes;
import it.deeptelegram.messenger.exoplayer.util.SystemClock;
