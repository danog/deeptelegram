...
import it.deeptelegram.messenger.exoplayer.drm.ExoMediaDrm.KeyRequest;
import it.deeptelegram.messenger.exoplayer.drm.ExoMediaDrm.OnEventListener;
import it.deeptelegram.messenger.exoplayer.drm.ExoMediaDrm.ProvisionRequest;
...
public class StreamingDrmSessionManager<T extends ExoMediaCrypto> implements DrmSessionManager<T> {
   ...
   *     obtained using {@link it.deeptelegram.messenger.exoplayer.ExoPlayer#getPlaybackLooper()}.
