...
public class PlayerControl implements MediaPlayerControl {
   ...
   * {@link it.deeptelegram.messenger.exoplayer.MediaCodecAudioTrackRenderer}, the recommended approach is
   * to extend the class and override
   * {@link it.deeptelegram.messenger.exoplayer.MediaCodecAudioTrackRenderer#onAudioSessionId}.
   *
